...
const ResetPassword = () => {
  ...
  return (
    <div style={{
      ...
      <div style={{ position: 'absolute', bottom: '20%', right: '10%', width: '18rem', height: '18rem', borderRadius: '50%', background: 'var(--accent-glow)', filter: 'blur(70px)', opacity: 0.3, pointerEvents: 'none' }} />
